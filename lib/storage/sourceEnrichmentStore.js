 ...
 * was never created (understand-layer5.sql unapplied). The first UPDATE failed
...
export async function persistUnderstandResults(sources) {
  ...
  if (knownMissing.size > 0) {
    console.warn(
      ...
      `apply docs/migrations/understand-layer5.sql / archiving migrations to enable them`
    );
  }
