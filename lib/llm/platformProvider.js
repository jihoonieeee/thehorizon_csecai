...
const MODEL_TIERS = {
  ...
  platform_ai: {
    cheap:     process.env.PLATFORM_MODEL_CHEAP     || "gpt-5.4",
    standard:  process.env.PLATFORM_MODEL_STANDARD  || "gpt-5.4",
    synthesis: process.env.PLATFORM_MODEL_SYNTHESIS || "gpt-5.4",
  },
};
