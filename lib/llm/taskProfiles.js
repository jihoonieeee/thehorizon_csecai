...
export const TASK_PROFILES = {
  ...
  source_filtering: {
    ...
    allow_local:         true,
    cost_rule:           "Sonnet — per-source pre-filter",
  },
  ...
  layer3_validation: {
    ...
    allow_local:         false,
    cost_rule:           "Sonnet — per-source validation; 52KB system prompt cached after first call in a run",
  },
  ...
  source_relevance: {
    ...
    allow_local:         true,
    cost_rule:           "Sonnet — per-source triage; gated by a deterministic keyword pre-pass so off-topic noise never reaches the LLM",
  },
  ...
  source_quality_gate: {
    ...
    allow_local:         true,
    cost_rule:           "Sonnet — content-quality classification",
  },
  ...
  source_typing: {
    ...
    allow_local:         true,
    cost_rule:           "Sonnet — source type disambiguation",
  },
  ...
  source_understanding: {
    ...
    allow_local:         true,
    cost_rule:           "Sonnet — taxonomy tagging and metadata extraction per source",
  },
  ...
  research_significance: {
    ...
    allow_local:         true,
    cost_rule:           "Sonnet — one call per research source, idempotent (never re-scored unless forced)",
  },
  ...
  slide_planning: {
    ...
    allow_local:         false,
    cost_rule:           "Sonnet — structured JSON slot-assignment, not reasoning; 5× cheaper than Opus with identical output",
  },
   ...
   */
  visual_planning: {
    description:         "Visual planning: Sonnet reviews slide content and emits visual_requirement per slide",
    preferred_providers: ["anthropic", "gemini"],
    anthropic_model:     "sonnet",
    gemini_tier:         "standard",
    max_tokens:          6000,
    ...
    allow_local:         false,
    cost_rule:           "Anthropic Sonnet — structured JSON slot-assignment from bounded evidence; 5x cheaper than Opus with equivalent output",
  },
};
