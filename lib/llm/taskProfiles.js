...
export const TASK_PROFILES = {
  ...
  source_filtering: {
    ...
    allow_local:         true,
    cost_rule:           "Haiku — cheap per-source pre-filter; Gemini Flash-Lite fallback",
  },
  ...
  source_quality_gate: {
    ...
    allow_local:         true,
    cost_rule:           "Haiku — simple 4-way classification, not analysis",
  },
  ...
  source_typing: {
    ...
    allow_local:         true,
    cost_rule:           "Haiku — simple classification, not analysis",
  },
