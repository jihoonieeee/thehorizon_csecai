...
export const TASK_PROFILES = {
   ...
   * One cheap call per source judges all of its extracted evidence items, supplying
   * the semantic fields the deterministic triage consumes: direct_demonstration,
   * concrete_claim, source_type_fit, observed_use, limitations. Haiku — per-source
   * batched judgement, not deep analysis. Deterministic gates still enforce everything.
   */
  evidence_judgment: {
    ...
    allow_local:         true,
    cost_rule:           "Haiku — one batched call per source over its few extracted items; never per item",
  },
