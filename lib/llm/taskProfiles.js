...
export const TASK_PROFILES = {
  ...
  source_understanding: {
    ...
    // Prompt now includes disambiguation examples + 3500-char source text — needs
    // a model that handles long structured prompts well. Use standard tier (2.5-pro
    // in dev/quality mode) for better taxonomy accuracy.
    preferred_providers: ["gemini", "openai", "groq", "openrouter"],
    gemini_tier:         "standard",  // 2.5-pro in dev/quality; 2.5-flash in cheap/local
    max_tokens:          3500,
    requires_json:       true,
    pipeline_layer:      "L4-taxonomy",
    allow_local:         true,
    cost_rule:           "classification accuracy is critical — use capable model; ~200 sources per run",
  },
