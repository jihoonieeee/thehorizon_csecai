...
export const TASK_PROFILES = {
   ...
   */
  /**
   * source_label — Layer 4 LLM label validation for non-research sources.
   * Confirms or overrides the deterministic label for incident / threat-intel /
   * exploit / capability-demo sources where source_type alone can mis-tier.
   * One Haiku call per eligible source at ingest; result stored in source_label column.
   */
  source_label: {
    description:         "Validate importance label (critical|important|supporting|archive) for incident/TI/exploit sources",
    preferred_providers: ["anthropic", "gemini", "groq", "openrouter"],
    anthropic_model:     "haiku",
    gemini_tier:         "lite",
    max_tokens:          400,
    requires_json:       true,
    pipeline_layer:      "L4-label",
    allow_local:         true,
    cost_rule:           "Haiku — one small call per eligible non-research source; idempotent",
  },
