...
export const TASK_PROFILES = {
  ...
  taxonomy_tagging: {
    ...
    allow_local:         false,
    cost_rule:           "Sonnet — L5 and above; better tag precision than Haiku",
  },
   ...
   * Sonnet: richer semantic judgement than Haiku for evidence quality decisions.
   */
  evidence_judgment: {
    ...
    allow_local:         false,
    cost_rule:           "Sonnet — L5 and above; one batched call per source",
  },

  /**
   * evidence_extraction — Layer 5A.3
   * Extract concrete, verifiable facts from source text with citation.
   * Sonnet: more precise fact/quote extraction and better numbers identification.
   */
  evidence_extraction: {
    ...
    allow_local:         false,
    cost_rule:           "Sonnet — L5 and above; better extraction quality than Haiku",
  },
  ...
  analytics_extraction: {
    ...
    allow_local:         false,
    cost_rule:           "Sonnet — L5 and above; controlled-vocab tagging with better precision",
  },
  ...
  category_synthesis: {
    ...
    pipeline_layer:      "L6-analysis-category-synthesis",
    allow_local:         false,
    cost_rule:           "Anthropic Opus — strongest model; one call per category (4 max/run); deterministic validator enforces evidence support",
  },
   ...
   * Highest-importance analytical slides. Always Opus (never downgraded).
   */
  slide_content_critical: {
    description:         "Critical-priority slide content: highest reasoning, never downgraded",
    preferred_providers: ["anthropic", "gemini"],
    anthropic_model:     "opus",
    gemini_tier:         "standard",
    max_tokens:          8000,
    ...
    allow_local:         false,
    cost_rule:           "Anthropic Opus always — critical claims must have maximum reasoning quality",
  },
