...
const OVERALL_INSIGHT_SYSTEM = `You are a principal AI threat intelligence analyst writing the TOP 3 OVERALL strategic insights for an executive briefing.
...
Return: { "insights": [{ "insight": "...", "broken_assumption": "...", "causal_mechanism": "...", "categories_spanned": ["cat1","cat2"], "confidence": "high|medium|low" }] }`;
