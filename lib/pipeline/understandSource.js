...
HARD REJECTION PATTERNS — always use unclear_or_adjacent for these:
...
the single best fit (use these exact values):
  ...
  Operational — something real happened or exists in the wild:
    ...
    exploit_disclosure       — a working exploit / PoC for a specific vulnerability
  ...
  Technical evidence — demonstrated or measured, usually in a lab:
    research_finding         — a paper/study/writeup demonstrating an attack, weakness, or method
    benchmark_evaluation     — an evaluation dataset, benchmark, or measurement study
    capability_demonstration — a demo/PoC showing a new capability (not tied to one CVE)
