...
function buildStrategicShiftSlide(pptx, slide, pageNum, total) {
  ...
  if (slide.implication?.trim()) {
    s.addShape("rect", { x: MARGIN, y: implY - 0.04, w: FULL_W, h: 0.02, fill: { color: T.silver }, line: { color: T.silver } });
    s.addShape("rect", { x: MARGIN, y: implY + 0.02, w: 0.07, h: IMPL_H - 0.06, fill: { color: T.amber }, line: { color: T.amber } });
    s.addText("IMPLICATION  ", {
      x: MARGIN + 0.16, y: implY + 0.02, w: 1.4, h: 0.22,
      fontSize: 9, bold: true, color: T.amber, fontFace: T.fontBody, charSpacing: 1,
    });
    s.addText(clamp(slide.implication, 200), {
      x: MARGIN + 0.16, y: implY + 0.22, w: FULL_W - 0.22, h: IMPL_H - 0.28,
      fontSize: 13, color: T.dark, fontFace: T.fontBody, valign: "top", wrap: true,
    });
  }
