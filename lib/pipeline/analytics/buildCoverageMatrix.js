...
const HORIZON_SOURCE_TYPES = new Set([
  ...
  "infrastructure_dependency_signal", "strategic_signal",
]);

// Source types that provide structural/contextual signals only
const CONTEXTUAL_SOURCE_TYPES = new Set([
  "defensive_capability", "governance_signal", "ecosystem_signal",
  "societal_harm_signal", "trust_boundary_shift",
]);
...
export function buildCoverageMatrix(features) {
  ...
  const SOURCE_TYPE_ORDER = [
    ...
    "benchmark_evaluation", "infrastructure_dependency_signal", "strategic_signal",
    "defensive_capability", "trust_boundary_shift", "governance_signal",
    "ecosystem_signal", "societal_harm_signal", "unknown",
  ];
