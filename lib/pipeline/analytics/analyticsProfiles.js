...
export const ANALYTICS_PROFILES = {
  ...
  exploit_disclosure: {
    ...
    optional_fields:    ["attack_surfaces","ai_layers","impact_types","signal_clusters"],
  ...
  ecosystem_signal: {
    description: "Ecosystem/market shifts, adoption trends, platform integrations",
    enabled_dimensions: [
      "ai_layer","technology","signal_cluster","recurring_theme",
      "sector","dependency_type","impact_scope",
    ],
    required_fields:    ["ai_layers","technologies"],
    optional_fields:    ["sectors","signal_clusters","dependency_types","recurring_themes"],
    aggregation_weight: 0.8,
    default_analytics_use: "limited_analytics",
    useful_chart_types: [
      "ecosystem_dependency_distribution","ai_layer_distribution","dependency_type_frequency",
    ],
    extraction_hints: "Focus on ecosystem/adoption shifts and downstream security impact.",
  },
  ...
  societal_harm_signal: {
    ...
    extraction_hints: "Focus on harm type, affected population, trust system, institutional response.",
  },
  ...
  infrastructure_dependency_signal: {
    description: "Dependency growth creating new attack surface — MCP servers, AI APIs",
    enabled_dimensions: [
      "ai_layer","technology","sector","signal_cluster","recurring_theme",
      "dependency_type","attack_surface","impact_scope",
    ],
    required_fields:    ["dependency_types","ai_layers"],
    optional_fields:    ["technologies","sectors","attack_surfaces","signal_clusters"],
    aggregation_weight: 1.0,
    default_analytics_use: "limited_analytics",
    useful_chart_types: [
      "dependency_type_frequency","ecosystem_dependency_distribution","ai_layer_distribution",
    ],
    extraction_hints: "Focus on dependency type, attack surface created, scope of exposure.",
  },
  ...
  trust_boundary_shift: {
    description: "Shifts in trust assumptions creating new exploit conditions",
    enabled_dimensions: [
      "ai_layer","technology","signal_cluster","recurring_theme",
      "trust_boundary_shift_type","impact_scope","impact_type",
    ],
    required_fields:    ["trust_boundary_shift_types","ai_layers"],
    optional_fields:    ["technologies","signal_clusters","impact_types","recurring_themes"],
    aggregation_weight: 1.0,
    default_analytics_use: "limited_analytics",
    useful_chart_types: [
      "trust_boundary_shift_frequency","ai_layer_distribution",
    ],
    extraction_hints: "Focus on trust assumption violated, affected context, systemic implication.",
  },

  strategic_signal: {
    description: "Long-range risk assessments, strategic trajectory analysis",
    enabled_dimensions: [
      "ai_layer","signal_cluster","recurring_theme","impact_scope",
    ],
    required_fields:    ["signal_clusters","recurring_themes"],
    optional_fields:    ["ai_layers","impact_scope"],
    aggregation_weight: 0.6,
    default_analytics_use: "limited_analytics",
    useful_chart_types: [
      "signal_cluster_heatmap","recurring_theme_heatmap",
    ],
    extraction_hints: "Focus on strategic theme, systemic risk, convergence signal.",
  },
