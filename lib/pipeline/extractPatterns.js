...
const PATTERN_SYSTEM = `You are a threat intelligence analyst clustering evidence items into meaningful attack patterns.
...
Total evidence items shown: ${items.length} (${strong.length} strong, ${usable.length} usable)
