...
// or CVE the text says is ACTIVELY EXPLOITED is upgraded to realized.
const IN_WILD_PHRASE = /\b(exploited in the wild|actively exploited|known exploited|under active exploitation|observed exploitation|being exploited)\b/i;
