...
const _overallInsightPrompts = loadPrompt("analysis/overall-insights");
const OVERALL_INSIGHT_SYSTEM = _overallInsightPrompts.system;
const OVERALL_INSIGHT_USER   = _overallInsightPrompts.user;
...
export async function generateOverallInsights(allCategoryInsights, allDevelopments, opts = {}) {
  ...
  const userPrompt = interpolate(OVERALL_INSIGHT_USER, { insights_block: insBlock });
