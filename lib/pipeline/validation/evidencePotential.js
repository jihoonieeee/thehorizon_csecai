...
const SOURCE_TYPE_POTENTIAL = {
  ...
  security_blog:             "context_only",
  news:                      "context_only",
  societal_harm:             "context_only",
  ai_lab_update:             "context_only",
  policy:                    "context_only",
  standard:                  "analytics_only",
...
const SOURCE_TYPE_USEFULNESS = {
  ...
  advisory:                  ["factual_claim_support", "recommendation_input"],
  ...
  security_blog:             ["context_only", "outlook_input"],
  news:                      ["context_only", "outlook_input"],
  ai_lab_update:             ["context_only"],
  societal_harm:             ["case_study_support", "context_only"],
  policy:                    ["recommendation_input", "context_only"],
  standard:                  ["chart_input", "context_only"],
...
export function computeEvidencePotential(source) {
  ...
  // Curated sources: always preserve for audit (never archive_only → analytics_only minimum)
  if (trustTier === "curated" && potential === "archive_only") {
    potential = "analytics_only";
  }
 ...
 *   layer4_review         — proceed but flag for human review
...
export function deriveSourceRoute(evidencePotential, layer3Status, downstreamRoute) {
  ...
  switch (evidencePotential) {
    case "primary_evidence_candidate":
      return layer3Status === "review" ? "layer4_review" : "layer4_evidence";

    case "supporting_evidence_candidate":
      return layer3Status === "review" ? "layer4_review" : "layer4_evidence";

    case "context_only":
      return layer3Status === "review" ? "layer4_review" : "layer4_context";
