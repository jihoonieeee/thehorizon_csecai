 ...
 *   3.5  applyFinalGate          — structural hard overrides (URL safety, curated protection,
 *                                  novelty rescue) then routes via the LLM verdict
...
export async function validateAndTypeSource(source, opts = {}) {
  ...
  if (validity.hard_fail) {
    ...
    if (l3) {
      ...
      if (isResearchSourceType(l3.source_type) && llm_verdict !== "reject") {
