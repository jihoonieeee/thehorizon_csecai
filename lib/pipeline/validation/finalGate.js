...
// Only "essential" and "recommended" research papers enter the corpus — "analyst"
...
export function applyFinalGate(validity, relevance, typing, trust, qualityOpts = {}) {
  ...
  // must be "essential" or "recommended" to enter the corpus. "analyst"-level papers
  ...
  // null (LLM failure) and "analyst"/"background" — all non-whitelist values reject.
  ...
  if (llm_verdict !== null) {
    ...
    // Note: "analyst" passes here for non-research types (incident, threat_intel,
