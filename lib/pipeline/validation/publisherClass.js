...
const SECURITY_FIRM_FRAGMENTS = [
  ...
  "trailofbits", "trail of bits", "nsfocus", "sygnia", "sysdig", "bishop fox",
  "wiz.io", "wiz research", "cloudsecurityalliance",
];
...
const MEDIA_FRAGMENTS = [
  ...
  // Additional confirmed from corpus audits (batch 15)
  "securityboulevard", "hipaajournal",
  // Additional confirmed from corpus audits (batch 19)
  "esecurityplanet",
  // Additional confirmed from corpus audits (batch 20)
  "techrepublic",
  // Additional confirmed from corpus audits (batch 26)
