...
import { extractAllPatterns }      from "./extractPatterns.js";
import { generateAllDevelopments } from "./generateDevelopments.js";
import { generateAllInsights }     from "./generateInsights.js";
import { selectAllCaseStudies }    from "./selectCaseStudies.js";
import { generateAllOutlooks }     from "./generateOutlook.js";
import { planSlideDeck }           from "./planSlides.js";
...
export async function runPipeline(sources, opts = {}) {
  ...
  const all_developments = await generateAllDevelopments(packsMap, patterns, corpus_summary, { skipLlm });
  ...
  const all_insights = await generateAllInsights(all_developments, evidenceItems, { skipLlm });
  ...
  if (!skipSlides) {
    ...
    deck = await buildPresentation(category_analyses, cross_category, evidenceItems, { skipLlm, corpusSummary: corpus_summary }, slide_plan);
