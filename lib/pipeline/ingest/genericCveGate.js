...
export function isGenericNoiseCve(r = {}) {
  ...
  // A vulnerability the classifier placed in unclear_or_adjacent is, by definition,
  // a conventional-appsec CVE with no AI-specific attack surface (the taxonomy prompt
  // routes generic SSRF/XSS/authz/path-traversal bugs there). Only ever touch the
  // unclear bucket — never second-guess a real offensive-category placement.
