...
/**
 * Tolerate a ±1-day difference between the stored date and the extracted date.
 * This accounts for timezone shifts (UTC±12) while rejecting matches that are
 * clearly wrong. 2 days was too loose for daily period reports — a 2-day error
 * can shift an article across a reporting-window boundary.
 */
const MAX_DELTA_DAYS = 1;
