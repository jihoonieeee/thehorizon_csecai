...
Produce 2-4 final strategic judgments. Merge overlapping findings. Use evidence IDs from above in evidence_for[].

MANDATORY — every judgment MUST populate all four fields with ≥1 full sentence:
  "judgment"          — precise falsifiable claim
  "what_changed"      — specific capability shift or disclosure
  "causal_mechanism"  — WHY this is happening now (the mechanism)
  "why_this_matters"  — which defender assumption breaks`;
