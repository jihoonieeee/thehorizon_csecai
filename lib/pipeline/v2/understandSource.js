...
Only classify as ai_enabled_threats if the source explicitly documents AI/ML being used as the attack tool (e.g. AI-generated deepfakes, LLM-written phishing, AI-assisted malware, AI-powered reconnaissance). Assign at least one AE01–AE10 primary_tag. Conventional threat campaigns that do not document AI usage belong in unclear_or_adjacent even if AI-adjacent.
