...
const MERMAID_INIT =
  "%%{init: {" +
    "'theme':'base'," +
    "'themeVariables':{" +
      "'fontFamily':'Arial,Helvetica,sans-serif','fontSize':'26px'," +   // large → legible when fit to the slide
      "'primaryColor':'#EAF1FB','primaryBorderColor':'#3583C9','primaryTextColor':'#1A1A2E'," +
      "'lineColor':'#64748B','tertiaryColor':'#F4F6F9','clusterBkg':'#F8FAFC','clusterBorder':'#CBD5E1'" +
    "}," +
    "'flowchart':{'curve':'basis','nodeSpacing':50,'rankSpacing':60,'padding':18,'useMaxWidth':false}," +
