...
import { ALL_EVIDENCE_TYPES } from "./evidenceExtractionProfiles.js";
...
function normalizeItem(rawItem, source, finalIndex) {
  ...
  const short_label    = typeof rawItem.short_label === "string"    ? rawItem.short_label.trim().slice(0, 100) : "";
  ...
  const item     = {
    ...
    evidence_type,
    fact,
    short_label:         short_label || fact.slice(0, 60),
    source_quote,
    ...
    numbers,
    date:                typeof rawItem.date === "string" ? rawItem.date : null,
