...
export const LIMITATIONS = [
  ...
  "non_english_source",
  // No named CVE, model, org, metric, date, technique, or reproducible reference
  // found in the fact or source_quote. Item is dramatic language only.
  // Cannot contribute to trend claims; capped to context-level evidence weight.
  "low_concreteness",
  // Hype language ("unprecedented", "explosive") with no concrete anchor.
  // Strength capped at "usable" by deterministic gate.
  "hype_flag_caps_strength",
];
...
export const LIMITATION_EFFECTS = {
  ...
  // low_concreteness blocks trend claims — no named anchors means a trend is just a
  // feeling, not something traceable across time windows.
  low_concreteness:         (c) => c.claim_type === "trend_claim",
  ...
  hype_flag_caps_strength:  () => false,   // caps strength but does not block claim type
};
...
export const CAVEAT_ONLY_LIMITATIONS = new Set([
  ...
  "unclear_reproducibility", "duplicate_reporting", "hype_flag_caps_strength",
]);
