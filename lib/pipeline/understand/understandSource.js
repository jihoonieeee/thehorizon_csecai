...
Your task: understand what this source is actually about, then assign the most precise PRIMARY TAGS and SUB-TECHNIQUES that the evidence directly supports.
...
AI-enabled threats (AE01–AE09) serve TWO roles:
1. PRIMARY DOMAIN: set primary_domain=ai_enabled_threats ONLY when the source is PRIMARILY about AI being used as an offensive tool for conventional cyber operations (deepfakes for fraud, AI phishing campaigns, etc.)
2. OVERLAY METADATA: set ai_enabled=true + ai_enabled_roles[AE01–AE09] on ANY source where AI materially enhances the attack, even when the primary domain is traditional_ai_threats, llm_threats, or agentic_ai_threats.
...
- source_summary: 2–3 analyst-grade sentences. What happened, AI-security significance, who is affected.
...
1. Use ONLY TAI01–TAI10, LLM01–LLM10, ASI01–ASI10, or AE01–AE09 tag IDs.
...
- ai_enabled_roles: array of AE01–AE09 roles (only when ai_enabled=true and different domain assigned)
