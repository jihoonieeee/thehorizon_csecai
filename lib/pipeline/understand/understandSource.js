        ...
        .map(r => {
          ...
          const row = {
            ...
            intelligence: {
              ...
              // Deterministic importance tier (no LLM, no cost).
              importance:           { ...computeImportance(r), scored_at: now },
              // Unified maturity level — deterministic fallback at ingest so every
              // new source lands pre-labelled; labelMaturityLevels.js upgrades to LLM.
              ...(() => { const m = deterministicMaturity(r); return { maturity_level: m.level, maturity_reason: m.reason, maturity_method: m.method, maturity_at: now }; })(),
