...
export const DOMAIN_RULES = {
  traditional_ai_threats:
    "The ML model, its artifacts or supply chain, training data, or inference behavior is attacked, without depending on language-model-specific mechanisms or autonomous agents.",
  llm_threats:
