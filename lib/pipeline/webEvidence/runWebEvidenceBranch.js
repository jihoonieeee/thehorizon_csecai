/**
 * Layer 5C — Web Evidence Branch orchestrator.
 *
 * Runs in parallel with 5A/5B and feeds Layer 6 (analysis) + Layer 7 (slides).
...
export async function runWebEvidenceBranch(params = {}) {
  ...
  const pkg = packageWebEvidenceForDossiers({
    selectedEvidence: qaSelected, allEvidence: evidence, visuals, unsupportedByCategory,
  });
