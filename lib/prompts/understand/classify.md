...
── llm_threats ── attacks on an LLM's language/prompt/context/RAG/output surface;
  ...
  LLM09_misinformation
    ...
    BELONGS WHEN: the central harm is TRUSTED FALSE OUTPUT generated by the model
      ...
      IMPORTANT: only apply if hallucination is the central attack mechanism of THIS
      SPECIFIC FINDING — not merely mentioned as background context from a surrounding
      report that covers multiple unrelated threats.
