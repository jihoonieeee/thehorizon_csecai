...
const PRIMARY_TAG_DEFS = [
  ...
  },
  {
    ...
    description: "AI-assisted disinformation, propaganda, narrative manipulation, or coordinated influence operations. Does not cover synthetic media used for fraud — see AE10.",
    framework_refs: ["DISARM Red Framework"],
    mapping_type: "operational_abstraction",
  },
  {
    id: "AE10_ai_enabled_deepfake",
    domain: "ai_enabled_threats",
    label: "AI-Enabled Deepfake and Synthetic Media",
    description: "AI-generated synthetic video, audio, or imagery used for fraud, impersonation, extortion, scams, or targeted harm. Includes face-swap attacks, voice cloning fraud, and non-consensual synthetic content. Distinct from AE09 (influence operations).",
    framework_refs: ["MITRE ATT&CK T1566", "MITRE ATT&CK T1655"],
    mapping_type: "operational_abstraction",
  },
];
