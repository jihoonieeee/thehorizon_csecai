...
// Candidate routing: binary. Every candidate is either accepted into the pipeline
// or rejected. Reason codes (candidate_route_reasons[]) carry the nuance.
export const DISCOVERY_ROUTES = ["accept", "reject"];
export const VALID_DISCOVERY_ROUTES = new Set(DISCOVERY_ROUTES);

export const ROUTES_INTO_PIPELINE = new Set(["accept"]);
...
export const MISSION_DEFAULT_SIGNAL_TYPE = {
  // Operational
  emerging_threats_this_week:         "new_attack_mode",
  new_actor_adoption:                 "new_actor_adoption",
  ai_enabled_adversary_campaigns:     "new_actor_adoption",
  ai_orchestrated_operations:         "new_actor_adoption",
  ...
  mcp_infrastructure_cve:             "new_exploit_path",
  llm_prompt_injection_production:    "new_attack_mode",
  llm_jailbreak_alignment_bypass:     "new_attack_mode",
  llm_information_disclosure:         "new_attack_path",
  // Attack surface
  ...
  // Traditional AI
  traditional_ai_model_extraction:    "new_attack_mode",
  traditional_ai_adversarial_evasion: "new_attack_mode",
  traditional_ai_poisoning_backdoors: "new_attack_mode",
  // Incidents & capability
  new_incident_or_case_study:         "new_actor_adoption",
  ai_offensive_security_tooling:      "operationalization_step",
  ai_autonomous_offensive_capability: "operationalization_step",
  automated_red_teaming:              "operationalization_step",
  deceptive_reasoning_failures:       "new_attack_mode",
  // Aggregate / trend
  new_benchmark_or_dataset:           "operationalization_step",
  new_statistics_or_trend_data:       "scale_shift",
  landscape_reports:                  "scale_shift",
};
...
// reject. These are matched against title + claim + publisher.
