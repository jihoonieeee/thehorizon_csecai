...
export const MISSION_DEFS = {
  ...
  new_ai_enabled_cybercrime: {
    ...
    domains: ["ai_enabled_threats"],
    primary_tags: ["AE02_ai_enabled_social_engineering", "AE07_ai_enabled_identity_abuse", "AE05_ai_enabled_malware_development"],
    seed_queries: [
  ...
  new_statistics_or_trend_data: {
    ...
    primary_tags: ["AE02_ai_enabled_social_engineering", "AE09_ai_enabled_disinformation_influence"],
    seed_queries: [
