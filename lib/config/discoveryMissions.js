...
export const MISSION_DEFS = {
  // Hunt for LANDSCAPE REPORTS — the meta-sources (threat landscapes, trackers,
  // annual/quarterly threat reports, disruption reports) that each contain 15-40
  // findings. These get fanned out into per-finding sources downstream. Targets the
  // vendors + AI labs that publish them; the report detector + full-text fetch do
  // the rest. Search is broad (year-scoped) since reports publish periodically.
  landscape_reports: {
    ...
    seed_queries: [
      ...
      "CrowdStrike global threat report AI",
      "Mandiant M-Trends AI adoption",
      "Unit 42 global incident response report AI",
      "Anthropic threat intelligence report AI misuse",
      "MITRE ATLAS adversarial machine learning update",
      "AI enabled threat intelligence report 2026",
      "state of AI security annual report",
    ],
