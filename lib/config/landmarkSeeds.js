...
export const LANDMARK_SEEDS = [
  ...
  // ── traditional_ai_threats — adversarial-ML reference anchors (added 2026-07-09) ──
  // Primary knowledge bases / taxonomies / agency guidance the corpus should
  // contain for the traditional-AI (attacks-on-ML) lane. URLs verified live
  // 2026-07-09. Imported via landmark backfill (Layer-3 typing runs; main_category
  // is nulled so classify re-derives).
  {
    ...
    source_type: "governance_signal",
    category: "traditional_ai_threats",
    why: "The canonical adversarial-ML knowledge base (tactics/techniques + real-world case studies) — the ATT&CK for AI. Foundational reference absent from the corpus.",
  },
  {
    ...
    source_type: "governance_signal",
    category: "traditional_ai_threats",
    why: "The authoritative AML taxonomy (evasion/poisoning/privacy/abuse + mitigations), 2025 revision. The reference vocabulary for the traditional-AI lane.",
  },
  {
    ...
    publisher: "UK NCSC / CISA (joint, 23 agencies)",
    source_type: "governance_signal",
    category: "traditional_ai_threats",
    why: "Joint national-agency secure-AI guidance across the AI lifecycle — the flagship AML/AI-security guidance document; anchors the agency-guidance lane.",
  },
  {
    ...
    source_type: "research_finding",
    category: "traditional_ai_threats",
    why: "Practitioner lessons from red-teaming 100 AI products — landmark AI-red-team primary source; the MS AI Red Team lane is otherwise absent.",
  },
];
