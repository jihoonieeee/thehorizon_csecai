...
> **Generated**: 2026-06-16T14:02:55.250Z
...
### [REVIEW] CISA Alert: Threat Actors Exploit LLM APIs to Automate Phishing Campaigns at Scale
- **source_id**: `undefined`
...
### [REVIEW] Microsoft Security Report: Adversarial ML Attacks Against AI-Powered Security Products
- **source_id**: `undefined`
- **layer3_status**: **review**
- **validation_status**: unknown
- **source_type**: threat_intelligence
...
### [REVIEW] Google DeepMind: Jailbreaking State-of-the-Art LLMs via Many-Shot In-Context Learning
- **source_id**: `undefined`
- **layer3_status**: **review**
- **validation_status**: unknown
